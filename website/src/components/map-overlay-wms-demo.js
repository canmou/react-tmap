...
export const MapOverlayWmsDemo = () => {
  ...
  const init = async () => {
     ...
     if (indexRef.current) {
      ...
      //     var url = `https://canmou-bucket.oss-cn-beijing.aliyuncs.com/tile/%E6%AD%A6%E6%B1%89%E5%B8%82/${z}/%E7%93%A6%E7%89%87/${x}_${y}.png`;
      //     if (x && y && z) {
      ...
      // });
      new indexRef.current.TMap.WMSLayer({
        url: 'http://localhost:8080/geoserver/tile/wms', // 地图服务地址
        map: indexRef.current.map, // 展示图层的地图对象
        ...
        params: { 
          ...
          layers: 'tile:111111111111111111', // 请求的图层名称 
          format: 'image/png', 
          // bbox: '114.18038033748121%2C30.473469123137388%2C114.49269223423694%2C30.65513637516338',
        }, 
        service: 'geoserver'
        // ?service=WMS&version=1.1.0&request=GetMap&layers=tile%3A111
        // &bbox=114.18038033748121%2C30.473469123137388%2C114.49269223423694%2C30.65513637516338
        // &width=768&height=446&srs=EPSG%3A3857&styles=&format=image%2Fpng
      });
    }
  }
  useEffect(() => {
